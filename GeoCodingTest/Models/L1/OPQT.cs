...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class OPQT
    {
        ...
        public Nullable<decimal> U_WGE_ShipmentPoint { get; set; }
        public string U_WGE_StatusTranfer { get; set; }
        public string U_WGE_WHRemark { get; set; }
        public Nullable<decimal> U_WGE_ServicePoint { get; set; }
        public string U_WGE_AP01 { get; set; }
        public string U_WGE_AP02 { get; set; }
        public string U_WGE_S06 { get; set; }
        public string U_WGE_S07 { get; set; }
        public Nullable<decimal> U_WGE_CostPoint { get; set; }
        public string U_WGE_P01 { get; set; }
        public string U_HMC_LBillNo { get; set; }
        public string U_WGE_P02 { get; set; }
        public string U_WGE_P06 { get; set; }
        public string U_WGE_P07 { get; set; }
        public string U_WGE_P08 { get; set; }
        public Nullable<System.DateTime> U_WGE_P10 { get; set; }
        public string U_WGE_StatusReceipt { get; set; }
        public string U_WGE_P11 { get; set; }
        public Nullable<System.DateTime> U_WGE_P04 { get; set; }
        public Nullable<System.DateTime> U_WGE_P05 { get; set; }
        public string U_WGE_AP03 { get; set; }
        public Nullable<System.DateTime> U_HMC_LBillDate { get; set; }
        public Nullable<System.DateTime> U_WGE_ReturnDate { get; set; }
        public string U_WGE_DraftNumber { get; set; }
        public string U_WGE_CustomerName { get; set; }
        public string U_WGE_licenseplate { get; set; }
        public string U_WGE_P12 { get; set; }
        public string U_WGE_SCN01 { get; set; }
        public Nullable<System.DateTime> U_WGE_P13 { get; set; }
        public Nullable<System.DateTime> U_WGE_P14 { get; set; }
        public string U_WGE_P15 { get; set; }
        public string U_WGE_P16 { get; set; }
        public string U_WGE_P17 { get; set; }
        public Nullable<System.DateTime> U_WGE_P18 { get; set; }
        public Nullable<System.DateTime> U_WGE_P19 { get; set; }
        public string U_WGE_P20 { get; set; }
        public string U_WGE_P21 { get; set; }
        public string U_WGE_P22 { get; set; }
        public string U_WGE_P23 { get; set; }
        public Nullable<decimal> U_WGE_QualityPoint { get; set; }
        ...
        public Nullable<decimal> U_ISS_InvAmount { get; set; }
        public string U_WGE_GR01 { get; set; }
        public string U_WGE_GR02 { get; set; }
        public string U_WGE_GR03 { get; set; }
        public string U_WGE_GR04 { get; set; }
        public string U_WGE_Salesman { get; set; }
        public string U_WGE_InvRemark { get; set; }
        public string U_WGE_PRTDSC { get; set; }
        public string U_WGE_QC01 { get; set; }
        public string U_WGE_QC02 { get; set; }
        public string U_WGE_QC03 { get; set; }
        public string U_WGE_QC04 { get; set; }
        public Nullable<System.DateTime> U_WGE_Pay01 { get; set; }
        public Nullable<System.DateTime> U_WGE_Pay02 { get; set; }
        public Nullable<decimal> U_WGE_DiscPrcnt { get; set; }
        public Nullable<decimal> U_WGE_Discount { get; set; }
        public Nullable<decimal> U_WGE_TotalBefore { get; set; }
        public Nullable<decimal> U_WGE_TotalPay { get; set; }
        public string U_JWS_Branch { get; set; }
        public Nullable<System.DateTime> U_JWS_TaxReportDate { get; set; }
        public string U_JWS_TaxVendor { get; set; }
        public string U_JWS_ShowinInputTaxReport { get; set; }
        public Nullable<System.DateTime> U_JWS_TaxDate { get; set; }
        public Nullable<int> U_JWS_ReceiptBy { get; set; }
        public Nullable<int> U_JWS_IssueBy { get; set; }
        public Nullable<System.DateTime> U_WGE_Booking { get; set; }
        public string U_WGE_Reason { get; set; }
        public string U_WGE_PrintNo { get; set; }
        public Nullable<System.DateTime> U_WGE_Delivery { get; set; }
        public string U_WGE_Labor { get; set; }
