...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class UITM
    {
        ...
        public string U_WGE_OItem { get; set; }
        public Nullable<int> U_WGE_ShelfLife { get; set; }
        public string U_WGE_Brand { get; set; }
        public string U_WGE_Channel { get; set; }
        public string U_WGE_SubCat { get; set; }
        public string U_WGE_PackagingSize { get; set; }
        public Nullable<decimal> U_WGE_StdYield { get; set; }
        public Nullable<decimal> U_WGE_StdManHour { get; set; }
        public string U_WGE_Package { get; set; }
        public string U_WGE_Properties { get; set; }
        public Nullable<decimal> U_WGE_InvPacking { get; set; }
        public string U_WGE_Rawmat { get; set; }
        public string U_WGE_Product { get; set; }
        public string U_WGE_ProductG { get; set; }
        public string U_WGE_BPCode { get; set; }
        public string U_WGE_BPName { get; set; }
        public string U_WGE_Suggest { get; set; }
        public string U_WGE_Type { get; set; }
        public string U_WGE_FDA { get; set; }
        public string U_WGE_HSCode { get; set; }
        public string U_WGE_FType { get; set; }
        public Nullable<short> U_WGE_GP { get; set; }
        public string U_JWS_Owner { get; set; }
        public string U_JWS_Impairment { get; set; }
        public string U_JWS_RecDocNo { get; set; }
        public Nullable<System.DateTime> U_JWS_RecDocDate { get; set; }
        public string U_JWS_Condition { get; set; }
        public string U_JWS_LifeChange { get; set; }
        public string U_JWS_FACost { get; set; }
        public Nullable<decimal> U_JWS_KW { get; set; }
        public Nullable<decimal> U_JWS_FASalvage { get; set; }
        public Nullable<decimal> U_JWS_FARate { get; set; }
        public string U_WGE_Ename { get; set; }
        public string U_WGE_Tname { get; set; }
        public string U_WGE_HiTi { get; set; }
        public string U_WGE_Pallet { get; set; }
    }
}
