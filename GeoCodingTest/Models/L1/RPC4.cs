...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class RPC4
    {
        ...
        public Nullable<decimal> ExtTaxRate { get; set; }
        public Nullable<decimal> ExtTaxSum { get; set; }
        public string TaxAmtSrc { get; set; }
        public Nullable<decimal> ExtTaxSumF { get; set; }
        public Nullable<decimal> ExtTaxSumS { get; set; }
    }
}
