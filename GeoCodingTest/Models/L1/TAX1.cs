...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class TAX1
    {
        ...
        public Nullable<decimal> ExtVatPcnt { get; set; }
        public Nullable<decimal> ExtVatSum { get; set; }
        public string VatSumSrc { get; set; }
        public Nullable<decimal> ExtVatSumF { get; set; }
        public Nullable<decimal> ExtVatSumS { get; set; }
    }
}
