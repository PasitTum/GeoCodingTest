...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class RDN1
    {
        ...
        public string U_WGE_APR01 { get; set; }
        public string U_WGE_APR02 { get; set; }
        public string U_WGW_ARR01 { get; set; }
        public string U_WGE_VName { get; set; }
        public Nullable<System.DateTime> U_WGE_RefInvDate { get; set; }
        public string U_WGE_RefInvNo { get; set; }
        public Nullable<decimal> U_WGE_RefInvAmount { get; set; }
        public string U_ISS_PromotionCode { get; set; }
        public string U_ISS_LineType { get; set; }
        public string U_WGE_RefDN { get; set; }
        public string U_WGE_RefCN { get; set; }
        public string U_WGE_FS { get; set; }
        public Nullable<decimal> U_WGE_TotalCost { get; set; }
        public Nullable<decimal> U_WGE_TotalForeign { get; set; }
        public Nullable<decimal> U_WGE_TotalCCY { get; set; }
    }
}
