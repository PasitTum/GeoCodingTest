...
namespace GeoCodingTest.Models.L1
{
    ...
    public partial class OCRD
    {
        ...
        public string U_WGE_OldCode { get; set; }
        public string U_WGE_Billing { get; set; }
        public string U_WGE_PayDetail { get; set; }
        public string U_WGE_GroupCode { get; set; }
        public string U_ISS01 { get; set; }
        public string U_ISS02 { get; set; }
        public string U_WGE_IncoTerm { get; set; }
        public string U_WGE_BeneficName { get; set; }
        public string U_WGE_OldGLAcct { get; set; }
        public string U_WGE_VendorType { get; set; }
        public string U_WGE_BillingIns { get; set; }
        public string U_WGE_ShippingCon { get; set; }
        public string U_WGE_Channel { get; set; }
        public string U_WGE_Property1 { get; set; }
        public string U_WGE_Property2 { get; set; }
        public string U_WGE_BillState { get; set; }
    }
}
